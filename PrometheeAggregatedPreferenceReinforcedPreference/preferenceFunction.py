def UsualCriterion(difference_between_evaulations, p, q):
    if difference_between_evaulations <= 0:
        return 0;
    else:
        return 1;

def UShapeCriterion(difference_between_evaulations, p, q):
    if difference_between_evaulations <= q:
        return 0;
    else:
        return 1;

def VShapeCriterion(difference_between_evaulations, p, q):
    if difference_between_evaulations <= 0:
        return 0;
...
def LevelCriterion(difference_between_evaulations, p, q):
    if difference_between_evaulations <= q:
        return 0;
    if difference_between_evaulations > p:
        return 1;
...
def VShapeWithIndifferenceCriterion(difference_between_evaulations, p, q):
    if difference_between_evaulations <= q:
        return 0;
    if difference_between_evaulations > p:
        return 1;
